...
exports.readAllFloaters = () => {
    if (hardware) {
        ...
        console.log(Boolean(hardware.floater2.digitalRead()))
        console.log(Boolean(hardware.floater3.digitalRead()))
        console.log(Boolean(hardware.floater4.digitalRead()))
        console.log(Boolean(hardware.floater5.digitalRead()))
